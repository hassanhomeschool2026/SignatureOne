    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14 space-y-16">
      ...
      <div className="flex flex-wrap items-center justify-center gap-3">
        <a 
          ...
          className="px-4 py-2 bg-[#FAF8F9] hover:bg-[#F0ECED] border border-[#F0ECED] text-xs font-bold text-[#18181B] rounded-xl transition-all"
        >
      ...
      <div id="cancellation-policy" className="bg-white rounded-3xl border border-[#F0ECED] p-6 sm:p-8 space-y-6 shadow-xs scroll-mt-24">
        ...
        <div className="space-y-4 text-xs sm:text-sm text-[#52525B] leading-relaxed">
          <div className="bg-[#FAF8F9] rounded-2xl p-5 border border-[#F0ECED] space-y-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 pt-1 font-semibold text-xs text-[#18181B]">
              <div className="p-2.5 rounded-lg bg-white border border-[#F0ECED]">
          ...
          <div className="space-y-3 pt-2">
            <div>
              <h4 className="font-bold text-[#18181B] uppercase text-xs tracking-wider">
            ...
            <div>
              ...
              <div className="mt-2 p-3.5 bg-[#FAF8F9] rounded-xl border border-[#F0ECED] text-xs text-[#52525B] space-y-1">
                <p>
      ...
      <div id="terms-policy" className="bg-white rounded-3xl border border-[#F0ECED] p-6 sm:p-8 space-y-6 shadow-xs scroll-mt-24">
        <div className="flex items-center gap-3 border-b border-[#F0ECED] pb-4">
          <span className="w-10 h-10 rounded-xl bg-[#FAF8F9] flex items-center justify-center text-[#B9827B]">
        ...
        <div className="space-y-4 text-xs sm:text-sm text-[#52525B] leading-relaxed">
          <div className="p-4 rounded-xl bg-[#FAF8F9] border border-[#F0ECED] text-xs space-y-2">
            <h3 className="font-bold text-[#18181B] uppercase tracking-wider text-[11px]">
          ...
          <div className="space-y-3 text-xs">
            <div>
              <h4 className="font-bold text-[#18181B] uppercase tracking-wider">
      ...
      <div id="fee-terms" className="bg-white rounded-3xl border border-[#F0ECED] p-6 sm:p-8 space-y-6 shadow-xs scroll-mt-24">
        <div className="flex items-center gap-3 border-b border-[#F0ECED] pb-4">
          <span className="w-10 h-10 rounded-xl bg-[#FAF8F9] flex items-center justify-center text-[#B9827B]">
        ...
        <div className="space-y-4 text-xs sm:text-sm text-[#52525B] leading-relaxed">
          <p>
            <strong className="text-[#18181B]">Separation of Fees:</strong> Business service fees are separate from statutory notarial fees. Official notarial fees are governed by Texas Government Code Chapter 406. Mobile travel, convenience, RON technology/platform services, after-hours availability, printing, package handling, scanbacks, drop-off, etc. are business/service charges and are not charges for performing the official notarial act itself.
          </p>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 text-xs pt-1">
            <div className="p-3 rounded-xl bg-[#FAF8F9] border border-[#F0ECED]">
              <span className="font-bold text-[#18181B] block">In-Person Convenience Fee</span>
              <span className="text-[#B9827B] font-extrabold text-sm">$15.00</span>
              <span className="text-[11px] text-[#71717A] block mt-0.5">+ statutory fees · Wylie meeting</span>
            </div>

            <div className="p-3 rounded-xl bg-[#FAF8F9] border border-[#F0ECED]">
              <span className="font-bold text-[#18181B] block">Mobile Service Fee</span>
              <span className="text-[#B9827B] font-extrabold text-sm">$35.00</span>
              <span className="text-[11px] text-[#71717A] block mt-0.5">+ statutory fees · Up to 12 miles</span>
            </div>

            <div className="p-3 rounded-xl bg-[#FAF8F9] border border-[#F0ECED]">
              <span className="font-bold text-[#18181B] block">RON Service Fee</span>
              <span className="text-[#B9827B] font-extrabold text-sm">$25.00</span>
              <span className="text-[11px] text-[#71717A] block mt-0.5">+ statutory fees · Business hours</span>
            </div>

            <div className="p-3 rounded-xl bg-[#FAF8F9] border border-[#F0ECED]">
              <span className="font-bold text-[#18181B] block">After-Hours RON Fee</span>
              <span className="text-[#B9827B] font-extrabold text-sm">$25.00 + After-Hours Fee</span>
              <span className="text-[11px] text-[#71717A] block mt-0.5">+ statutory fees · Evenings &amp; Sun</span>
            </div>

            <div className="p-3 rounded-xl bg-[#FAF8F9] border border-[#F0ECED]">
              <span className="font-bold text-[#18181B] block">Loan Closings / Large Packages</span>
              <span className="text-[#B9827B] font-extrabold text-sm">Starting at $50+</span>
              <span className="text-[11px] text-[#71717A] block mt-0.5">Custom quote required</span>
            </div>

            <div className="p-3 rounded-xl bg-[#FAF8F9] border border-[#F0ECED]">
              <span className="font-bold text-[#18181B] block">Document Printing</span>
              <span className="text-[#B9827B] font-extrabold text-sm">$1.00 / page</span>
              <span className="text-[11px] text-[#71717A] block mt-0.5">Under 10 pages · Advance request required</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div id="privacy-policy" className="bg-white rounded-3xl border border-[#F0ECED] p-6 sm:p-8 space-y-6 shadow-xs scroll-mt-24">
        <div className="flex items-center gap-3 border-b border-[#F0ECED] pb-4">
          <span className="w-10 h-10 rounded-xl bg-[#FAF8F9] flex items-center justify-center text-[#B9827B]">
        ...
        <div className="space-y-3 text-xs sm:text-sm text-[#52525B] leading-relaxed">
          <p>
          ...
          <p>
            <strong className="text-[#18181B]">Notarial Recordkeeping:</strong> Texas Government Code mandates that notaries maintain an official record book containing specific details of each notarial act performed. These records are maintained in strict accordance with Texas laws and regulations.
          </p>
          <p>
            <strong className="text-[#18181B]">Non-Disclosure:</strong> We never sell, rent, or lease client personal information to third parties. Information may only be disclosed when required by Texas law, subpoena, or authorized regulatory authorities.
          </p>
          <p>
