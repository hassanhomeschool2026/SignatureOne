...
export const ServicesPage: React.FC<ServicesPageProps> = ({
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14 space-y-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {SERVICES.map((service) => {
          ...
          return (
            <div
              key={service.id}
              className="bg-white rounded-2xl border border-[#F0ECED] p-6 flex flex-col justify-between hover:border-[#E8C9C5] transition-all shadow-2xs"
            >
              <div className="space-y-4">
                ...
                <div>
                  <h3 className="text-base font-bold text-[#18181B] font-heading">{service.title}</h3>
                  <p className="text-xs text-[#71717A] mt-0.5">{service.subtitle}</p>
                </div>

                <div className="pt-2 border-t border-[#F0ECED]">
                  <div className="text-xl font-extrabold text-[#18181B]">{service.baseFee}</div>
                  <div className="text-[11px] text-[#71717A]">{service.feeNote}</div>
                </div>
                ...
                <ul className="space-y-1.5 text-xs text-[#52525B] pt-2 border-t border-[#F0ECED]">
                ...
                {isLoanSigning ? (
                  <div className="flex flex-col gap-2">
                    ...
                    <button
                      ...
                      className="w-full py-2 bg-[#FAF8F9] hover:bg-[#F0ECED] text-[#18181B] text-xs font-semibold rounded-xl transition-all cursor-pointer"
                    >
                      View Details
                    </button>
                  </div>
      ...
      <div className="bg-[#FAF8F9] rounded-3xl border border-[#F0ECED] p-6 sm:p-8 space-y-8">
        ...
        <div className="space-y-6">
          ...
          {/* In-Person Flow */}
          <div className="bg-white rounded-2xl p-5 border border-[#F0ECED] space-y-3 shadow-2xs">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-4 gap-3 pt-1">
              <div className="bg-[#FAF8F9] rounded-xl p-3 text-center space-y-1">
                <div className="w-6 h-6 rounded-full bg-[#18181B] text-white text-[11px] font-bold flex items-center justify-center mx-auto">1</div>
                <div className="font-bold text-xs text-[#18181B]">Book</div>
                <div className="text-[11px] text-[#71717A]">Select time &amp; place $10 deposit</div>
              </div>
              <div className="bg-[#FAF8F9] rounded-xl p-3 text-center space-y-1">
                <div className="w-6 h-6 rounded-full bg-[#18181B] text-white text-[11px] font-bold flex items-center justify-center mx-auto">2</div>
                <div className="font-bold text-xs text-[#18181B]">Meet</div>
                <div className="text-[11px] text-[#71717A]">Meet in Wylie, TX with valid ID</div>
              </div>
              <div className="bg-[#FAF8F9] rounded-xl p-3 text-center space-y-1">
                <div className="w-6 h-6 rounded-full bg-[#18181B] text-white text-[11px] font-bold flex items-center justify-center mx-auto">3</div>
                <div className="font-bold text-xs text-[#18181B]">Sign</div>
                <div className="text-[11px] text-[#71717A]">Sign in presence of the notary</div>
              </div>
              <div className="bg-[#FAF8F9] rounded-xl p-3 text-center space-y-1">
                ...
                <div className="font-bold text-xs text-[#18181B]">Notarize</div>
                <div className="text-[11px] text-[#71717A]">Receive sealed documents &amp; receipt</div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-5 border border-[#F0ECED] space-y-3 shadow-2xs">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-4 gap-3 pt-1">
              <div className="bg-[#FAF8F9] rounded-xl p-3 text-center space-y-1">
                <div className="w-6 h-6 rounded-full bg-[#18181B] text-white text-[11px] font-bold flex items-center justify-center mx-auto">1</div>
                <div className="font-bold text-xs text-[#18181B]">Book</div>
                <div className="text-[11px] text-[#71717A]">Reserve mobile slot with address</div>
              </div>
              <div className="bg-[#FAF8F9] rounded-xl p-3 text-center space-y-1">
                <div className="w-6 h-6 rounded-full bg-[#18181B] text-white text-[11px] font-bold flex items-center justify-center mx-auto">2</div>
                <div className="font-bold text-xs text-[#18181B]">We Travel</div>
                <div className="text-[11px] text-[#71717A]">Notary arrives with verified ETA</div>
              </div>
              <div className="bg-[#FAF8F9] rounded-xl p-3 text-center space-y-1">
                <div className="w-6 h-6 rounded-full bg-[#18181B] text-white text-[11px] font-bold flex items-center justify-center mx-auto">3</div>
                <div className="font-bold text-xs text-[#18181B]">Sign</div>
                <div className="text-[11px] text-[#71717A]">Verify IDs &amp; execute document signatures</div>
              </div>
              <div className="bg-[#FAF8F9] rounded-xl p-3 text-center space-y-1">
                <div className="w-6 h-6 rounded-full bg-[#B9827B] text-white text-[11px] font-bold flex items-center justify-center mx-auto">4</div>
                <div className="font-bold text-xs text-[#18181B]">Notarize</div>
                <div className="text-[11px] text-[#71717A]">Affix seal &amp; settle balance</div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-5 border border-[#F0ECED] space-y-3 shadow-2xs">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-5 gap-3 pt-1">
              <div className="bg-[#FAF8F9] rounded-xl p-3 text-center space-y-1">
                <div className="w-6 h-6 rounded-full bg-[#18181B] text-white text-[11px] font-bold flex items-center justify-center mx-auto">1</div>
                <div className="font-bold text-xs text-[#18181B]">Book</div>
                <div className="text-[11px] text-[#71717A]">Schedule online session</div>
              </div>
              <div className="bg-[#FAF8F9] rounded-xl p-3 text-center space-y-1">
                <div className="w-6 h-6 rounded-full bg-[#18181B] text-white text-[11px] font-bold flex items-center justify-center mx-auto">2</div>
                <div className="font-bold text-xs text-[#18181B]">Verify ID</div>
                <div className="text-[11px] text-[#71717A]">Complete ID analysis &amp; KBA</div>
              </div>
              <div className="bg-[#FAF8F9] rounded-xl p-3 text-center space-y-1">
                <div className="w-6 h-6 rounded-full bg-[#18181B] text-white text-[11px] font-bold flex items-center justify-center mx-auto">3</div>
                <div className="font-bold text-xs text-[#18181B]">Meet Online</div>
                <div className="text-[11px] text-[#71717A]">Join secure video call</div>
              </div>
              <div className="bg-[#FAF8F9] rounded-xl p-3 text-center space-y-1">
                <div className="w-6 h-6 rounded-full bg-[#18181B] text-white text-[11px] font-bold flex items-center justify-center mx-auto">4</div>
                <div className="font-bold text-xs text-[#18181B]">Sign</div>
                <div className="text-[11px] text-[#71717A]">E-sign on live video</div>
              </div>
              <div className="bg-[#FAF8F9] rounded-xl p-3 text-center space-y-1">
                ...
                <div className="font-bold text-xs text-[#18181B]">Notarize</div>
                <div className="text-[11px] text-[#71717A]">Download sealed PDF instantly</div>
              </div>
            </div>
          </div>
      ...
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 border-b border-[#F0ECED] pb-3">
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-[#18181B] font-heading uppercase">
          ...
          <div className="relative w-full sm:w-64">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-2 bg-white rounded-xl border border-[#F0ECED] text-xs text-[#18181B] placeholder-[#71717A] focus:outline-none focus:border-[#B9827B]"
            />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {DOCUMENT_CATEGORIES.map((cat, idx) => {
            ...
            return (
              <div key={idx} className="bg-white rounded-2xl border border-[#F0ECED] p-5 space-y-3 shadow-2xs">
                <h3 className="text-xs font-bold text-[#18181B] font-heading border-b border-[#FAF8F9] pb-2 flex items-center gap-2">
      ...
      <div className="bg-white rounded-3xl border border-[#F0ECED] p-6 sm:p-8 space-y-6 shadow-xs">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          ...
          {/* Quick ZIP checker */}
          <div className="w-full lg:w-80 bg-[#FAF8F9] rounded-2xl p-4 border border-[#F0ECED] space-y-3">
            <h3 className="text-xs font-bold uppercase tracking-wider text-[#18181B]">
            ...
            <form onSubmit={handleZipCheck} className="flex gap-2">
              <input
                ...
                className="flex-1 px-3 py-2 bg-white rounded-xl border border-[#F0ECED] text-xs text-[#18181B] placeholder-[#71717A] focus:outline-none focus:border-[#B9827B]"
              />
              <button
                type="submit"
                className="px-3 py-2 bg-[#18181B] text-white text-xs font-bold rounded-xl hover:bg-[#27272A] transition-all"
              >
                Check
              </button>
            </form>
            ...
            {zipResult && (
              <div className={`p-2.5 rounded-xl text-xs ${
                zipResult.within 
                  ? 'bg-[#E8C9C5]/30 text-[#18181B] border border-[#B9827B]/30' 
                  : 'bg-white text-[#52525B] border border-[#F0ECED]'
              }`}>
                {zipResult.within ? (
        ...
        <div className="pt-4 border-t border-[#F0ECED] space-y-3">
          <p className="text-xs font-bold uppercase tracking-wider text-[#18181B]">
          ...
          <div className="flex flex-wrap gap-2">
            {SERVICE_AREA_COMMUNITIES.map((c, i) => (
              <span 
                key={i} 
                className="text-xs px-3 py-1 bg-[#FAF8F9] border border-[#F0ECED] rounded-xl text-[#52525B]"
              >
                <strong className="text-[#18181B]">{c.name}</strong> ({c.zip}) · {c.distanceMiles} mi
              </span>
            ))}
          </div>
        </div>
