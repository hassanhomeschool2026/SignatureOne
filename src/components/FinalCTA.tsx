...
export const FinalCTA: React.FC<FinalCTAProps> = ({
  ...
  return (
    <section id="final-cta" className="py-16 md:py-24 bg-[#FAF8F9] relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="bg-[#FFFFFF] rounded-3xl p-8 sm:p-12 md:p-16 border border-[#E4E4E7] shadow-xl text-center space-y-6">
          
          <div className="inline-flex items-center gap-1.5 px-3.5 py-1 rounded-full text-xs font-semibold uppercase tracking-wider bg-[#FAF8F9] text-[#27272A] border border-[#E4E4E7]">
            <Sparkles className="w-3.5 h-3.5 text-[#B9827B]" />
            Get Started Today
          </div>

          <div className="space-y-2 max-w-2xl mx-auto">
            <h2 className="font-serif text-3.5xl sm:text-4.5xl md:text-5xl font-bold text-[#27272A] tracking-tight">
          ...
          <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-3.5 max-w-xl mx-auto">
            ...
            <button
              ...
              onClick={onOpenQuote}
              className="w-full sm:w-auto py-3.5 px-6 bg-[#27272A] hover:bg-[#3F3F46] active:scale-[0.98] text-white font-semibold text-xs tracking-wider uppercase rounded-xl transition-all shadow-xs flex items-center justify-center gap-2"
            >
            ...
            <button
              ...
              className="w-full sm:w-auto py-3.5 px-5 bg-white hover:bg-[#FAF8F9] active:scale-[0.98] text-[#27272A] border border-[#E4E4E7] font-semibold text-xs tracking-wider uppercase rounded-xl transition-all flex items-center justify-center gap-1.5"
            >
          ...
          <div className="pt-2 text-xs text-[#71717A] flex items-center justify-center gap-2">
