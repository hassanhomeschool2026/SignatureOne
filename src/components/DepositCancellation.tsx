...
export const DepositCancellation: React.FC = () => {
  ...
  return (
    <section id="deposit-cancellation" className="py-16 md:py-24 bg-[#F8F4EF]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-14">
          ...
          <div className="lg:col-span-6 bg-white rounded-3xl p-6 sm:p-8 border border-[#D8CEC7] shadow-sm flex flex-col justify-between space-y-6">
            <div className="space-y-4">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-semibold bg-[#E8C9C5]/50 text-[#292727] border border-[#E8C9C5]">
              ...
              <div className="p-4 bg-[#F8F4EF] rounded-2xl border border-[#D8CEC7] text-xs text-[#292727] leading-relaxed space-y-2">
                <p className="font-medium text-sm text-[#292727]">
              ...
              <ul className="space-y-2.5 text-xs text-[#554E4A]">
          ...
          <div className="lg:col-span-6 bg-white rounded-3xl p-6 sm:p-8 border border-[#D8CEC7] shadow-sm space-y-6">
            <div className="space-y-4">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-semibold bg-[#F8F4EF] text-[#292727] border border-[#D8CEC7]">
            ...
            <div className="space-y-3">
              {/* 48+ hrs */}
              <div className="p-3.5 rounded-xl bg-[#F8F4EF] border border-[#D8CEC7] flex items-start gap-3">
                <div className="w-6 h-6 rounded-full bg-[#E8C9C5] flex items-center justify-center text-[#292727] shrink-0 mt-0.5 text-xs font-bold">
                  ✓
                </div>
                <div>
                  ...
                  <p className="text-[11px] text-[#554E4A] mt-0.5">
                    The $10 booking deposit is <strong className="text-[#292727]">fully refundable</strong>.
                  </p>
                </div>
              </div>
              ...
              {/* Under 48 hrs */}
              <div className="p-3.5 rounded-xl bg-[#F8F4EF] border border-[#D8CEC7] flex items-start gap-3">
                <div className="w-6 h-6 rounded-full bg-[#D8CEC7] flex items-center justify-center text-[#292727] shrink-0 mt-0.5 text-xs font-bold">
                  !
                </div>
                <div>
                  <h4 className="font-semibold text-xs text-[#292727]">
        ...
        <div className="bg-white rounded-3xl p-6 sm:p-8 border border-[#D8CEC7] shadow-sm">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-3">
            {paymentSteps.map((s, idx) => (
              <div key={idx} className="bg-[#F8F4EF] p-3.5 rounded-xl border border-[#D8CEC7] space-y-1 text-center relative">
                <span className="text-[10px] font-bold uppercase tracking-wider text-[#B9827B] block">
                  Step 0{idx + 1}
                </span>
                <h4 className="font-bold text-xs text-[#292727]">
                  {s.title}
                </h4>
                <p className="text-[10px] text-[#786F6A] leading-tight pt-0.5">
                  {s.desc}
                </p>
              </div>
            ))}
