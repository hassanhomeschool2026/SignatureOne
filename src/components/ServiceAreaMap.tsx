...
export const ServiceAreaMap: React.FC = () => {
  ...
  return (
    <section id="service-area" className="py-16 md:py-24 bg-[#FAF8F9]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              <div
                ...
                className={`p-5 rounded-2xl border transition-all cursor-pointer ${
                  activeTab === idx
                    ...
                    : 'bg-white/70 border-[#E4E4E7] hover:bg-white hover:border-[#B9827B]/60'
                }`}
              >
                <div className="flex items-start justify-between">
                  <div className="flex items-center gap-3">
                    <div
                      className={`w-9 h-9 rounded-xl flex items-center justify-center ${
                        activeTab === idx ? 'bg-[#E8C9C5] text-[#27272A]' : 'bg-[#FAF8F9] text-[#71717A]'
                      }`}
                    >
                  ...
                  <span className="text-[11px] font-medium px-2 py-0.5 rounded-full bg-[#FAF8F9] border border-[#E4E4E7] text-[#27272A]">
                    {tier.fee}
                  </span>
                </div>
                <p className="text-xs text-[#52525B] mt-3 pl-12 leading-relaxed">
                  {tier.description}
                </p>
              </div>
            ))}
          ...
          <div className="lg:col-span-6">
            <div className="bg-white rounded-3xl p-6 sm:p-8 border border-[#E4E4E7] shadow-lg space-y-6">
              <div className="flex items-center justify-between border-b border-[#E4E4E7] pb-4">
                <div>
                  <h3 className="font-serif text-lg font-bold text-[#27272A]">
                ...
                <span className="inline-flex items-center gap-1 text-[11px] font-semibold text-[#B9827B] bg-[#FAF8F9] px-2.5 py-1 rounded-full border border-[#E8C9C5]">
              ...
              <div className="relative bg-[#FAF8F9] rounded-2xl p-6 border border-[#E4E4E7]/70 flex flex-col items-center justify-center text-center overflow-hidden min-h-[220px]">
                {/* Concentric Circles */}
                <div className="absolute w-72 h-72 rounded-full border border-[#E4E4E7]/80 pointer-events-none"></div>
                <div className="absolute w-52 h-52 rounded-full border border-dashed border-[#B9827B]/60 bg-[#E8C9C5]/15 pointer-events-none"></div>
                <div className="absolute w-28 h-28 rounded-full bg-[#FFFFFF] border-2 border-[#27272A] shadow-sm flex flex-col items-center justify-center z-10">
                  <MapPin className="w-5 h-5 text-[#B9827B]" />
                  <span className="text-[10px] font-bold text-[#27272A] uppercase tracking-wider mt-0.5">
                    75166
                  </span>
                  <span className="text-[9px] text-[#71717A]">Lavon, TX</span>
                </div>

                <div className="absolute bottom-3 inset-x-0 flex items-center justify-center gap-4 text-[10px] text-[#71717A] font-medium z-10">
              ...
              <div>
                <span className="block text-xs font-semibold text-[#27272A] uppercase tracking-wider mb-2.5">
                ...
                <div className="flex flex-wrap gap-1.5">
                  {communities.map((c, i) => (
                    <span
                      key={i}
                      className="text-xs px-2.5 py-1 rounded-lg bg-[#FAF8F9] border border-[#E4E4E7] text-[#27272A] font-medium"
                    >
                      {c}
                    </span>
                  ))}
              ...
              <div className="p-3.5 bg-[#FAF8F9] rounded-xl border border-[#E4E4E7] text-xs text-[#71717A] flex items-start gap-2">
