...
export const HeroBanner: React.FC<HeroBannerProps> = ({
  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-b from-[#FAF8F9] via-[#FAF8F9] to-[#FAF8F9] border-b border-[#F0ECED]/60">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-12 sm:pt-12 sm:pb-16 relative">
        ...
        <div className="relative rounded-3xl bg-gradient-to-r from-[#FAF8F9] via-[#FFFFFF] to-[#FAF8F9] border border-[#F0ECED] shadow-lg overflow-hidden p-6 sm:p-10 lg:p-12">
          
          {/* Subtle background decorative shapes: Coffee mug, Blush Notebook, Stamp accents */}
          <div className="absolute -top-10 right-24 w-28 h-28 rounded-full border-4 border-[#F0ECED]/70 bg-gradient-to-br from-[#FFFFFF] to-[#E4E4E7] opacity-40 pointer-events-none hidden md:block">
            <div className="w-16 h-16 rounded-full bg-[#E8C9C5]/40 m-auto mt-4"></div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
            ...
            <div className="lg:col-span-8 space-y-5 text-center lg:text-left">
              ...
              <div className="space-y-2">
                <p className="text-xs sm:text-sm font-semibold tracking-[0.25em] uppercase text-[#18181B]/80 font-heading">
                ...
                <h1 className="font-heading text-2xl sm:text-3xl lg:text-4xl font-extrabold text-[#18181B] tracking-tight leading-snug">
                  Bringing Notary Services To You
                </h1>
              </div>

              <p className="text-sm sm:text-base text-[#52525B] max-w-2xl mx-auto lg:mx-0 font-normal leading-relaxed">
              ...
              <div className="pt-2 flex flex-wrap items-center justify-center lg:justify-start gap-3">
                ...
                <button
                  id="hero-quote-btn"
                  onClick={onOpenQuote}
                  className="py-3 px-5 bg-[#18181B] hover:bg-[#27272A] active:scale-[0.98] text-white text-xs sm:text-sm font-semibold tracking-wider uppercase rounded-xl transition-all shadow-xs flex items-center gap-2"
                >
                ...
                {onNavigateToTab && (
                  <button
                    ...
                    className="py-3 px-4 bg-white hover:bg-[#FAF8F9] border border-[#E4E4E7] text-[#18181B] text-xs sm:text-sm font-medium rounded-xl transition-all flex items-center gap-1.5"
                  >
              ...
              {/* Trust Badges */}
              <div className="pt-3 border-t border-[#F0ECED]/70 flex flex-wrap items-center justify-center lg:justify-start gap-y-2 gap-x-5 text-xs text-[#52525B]">
