...
export const Footer: React.FC<FooterProps> = ({
  ...
  return (
    <footer className="bg-[#1E1B18] text-[#E0DAD5] py-10 border-t border-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Main Clean Row */}
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 pb-8 border-b border-[#332E2B] items-start">
      ...
      {activeLegalModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/75 backdrop-blur-xs">
          <div className="bg-white text-[#1E1B18] p-6 sm:p-8 rounded-2xl max-w-lg w-full border border-[#D8CEC7] shadow-2xl space-y-4">
            <h3 className="text-lg font-bold capitalize text-[#1E1B18]">
            ...
            <div className="pt-2 text-right">
              <button
                ...
                className="px-4 py-2 bg-[#1E1B18] text-white text-xs font-semibold rounded-lg hover:bg-black"
              >
                Close
              </button>
            </div>
