...
export const AfterHoursSection: React.FC<AfterHoursSectionProps> = () => {
  return (
    <section id="after-hours" className="py-16 md:py-20 bg-[#27272A] text-white relative overflow-hidden">
      {/* Subtle Glows */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-semibold uppercase tracking-wider bg-[#3F3F46] border border-[#52525B] text-[#E8C9C5]">
            ...
            <div className="space-y-2">
              ...
              <p className="text-base text-[#E4E4E7] max-w-xl mx-auto lg:mx-0 font-normal leading-relaxed">
            ...
            <div className="space-y-2.5 text-xs text-[#E4E4E7] max-w-lg mx-auto lg:mx-0">
              <div className="flex items-center gap-2 bg-[#3F3F46]/60 p-2.5 rounded-lg border border-[#52525B]">
          ...
          <div className="lg:col-span-5">
            <div className="bg-[#FFFFFF] text-[#27272A] rounded-2xl p-6 sm:p-7 shadow-2xl border border-[#E8C9C5]/40 relative">
              <div className="flex items-center justify-between pb-4 border-b border-[#E4E4E7]">
                ...
                <span className="px-2.5 py-1 rounded-full text-[11px] font-semibold bg-[#E8C9C5]/60 text-[#27272A]">
                  Evening Service
                </span>
              </div>
              ...
              <div className="py-4 space-y-3 text-xs">
                <div className="flex items-center justify-between py-1 border-b border-[#E4E4E7]/40">
                  <span className="text-[#52525B]">Texas Statutory Notarial Fee (1st sig)</span>
                  <span className="font-semibold text-[#27272A]">$10.00</span>
                </div>
                <div className="flex items-center justify-between py-1 border-b border-[#E4E4E7]/40">
                  <span className="text-[#52525B]">SignatureOne RON Platform Fee</span>
                  <span className="font-semibold text-[#27272A]">$25.00</span>
                </div>
                <div className="flex items-center justify-between py-1 border-b border-[#E4E4E7]/40">
                  <span className="text-[#52525B]">SignatureOne After-Hours Service Fee</span>
                  <span className="font-semibold text-[#B9827B]">+$25.00</span>
                </div>
                <div className="flex items-center justify-between pt-2 text-sm font-bold text-[#27272A]">
                  <span>Total Estimated Fee</span>
                  <span className="font-serif text-xl text-[#27272A]">$60.00</span>
                </div>
              </div>

              {/* Clear notice */}
              <div className="p-3 bg-[#FAF8F9] rounded-xl border border-[#E4E4E7] text-[11px] text-[#71717A] leading-relaxed">
