...
export const DocumentServices: React.FC<DocumentServicesProps> = ({
  ...
  return (
    <section id="document-types" className="py-16 md:py-24 bg-[#FAF8F9]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {DOCUMENT_CATEGORIES.map((doc, idx) => (
            <div
              key={idx}
              className="bg-[#FFFFFF] rounded-2xl p-5 border border-[#E4E4E7] hover:border-[#B9827B] transition-all hover:shadow-md flex flex-col justify-between"
            >
              <div className="space-y-3">
                <div className="flex items-center gap-2.5">
                  <div className="w-7 h-7 rounded-lg bg-[#FAF8F9] border border-[#E8C9C5] flex items-center justify-center text-[#B9827B] shrink-0 text-xs font-semibold font-serif">
                    0{idx + 1}
                  </div>
                ...
                <ul className="space-y-1.5 text-xs text-[#52525B] pl-1">
        ...
        <div className="mt-12 max-w-3xl mx-auto bg-[#FFFFFF] rounded-2xl p-6 border-2 border-[#E8C9C5] shadow-xs">
          <div className="flex items-start gap-4">
            ...
            <div className="space-y-2">
              <h4 className="font-serif text-lg font-bold text-[#27272A]">
              ...
              <div className="pt-1">
                <button
                  ...
                  className="text-xs font-semibold text-[#B9827B] hover:text-[#27272A] transition-colors inline-flex items-center gap-1"
                >
